...
namespace UnityEditor.ShaderGraph
{
    public struct PreviewProperty
    {
        ...
        public Texture textureValue
        {
            get
            {
                if (propType != PropertyType.Texture && propType != PropertyType.Texture2DArray)
        ...
        {
            if ((propType == PropertyType.Texture || propType == PropertyType.Texture2DArray) && textureValue != null)
