...
namespace UnityEditor.MaterialGraph
{
    public class MaterialGraphDataSource : ICanvasDataSource
    {
        ...
        public CanvasElement[] FetchElements()
        {
            ...
            int lowestZIndex = int.MaxValue;
            foreach ( CanvasElement e in toReturn )
            {
                if ( e.zIndex < lowestZIndex )
                {
                    lowestZIndex = e.zIndex;
                }
            }
        ...
        private void CommentBoxMoved(List<CanvasElement> elements, Vector2 motion)
        {
